...
rule1_match = np.fmin(rule1, match_s[2])
...
rule2_match = np.fmin(rule2, match_s[1])
...
rule3_match = np.fmin(rule3, match_s[2])
...
rule4_match = np.fmin(rule4, match_s[2])
...
rule5_match = np.fmin(rule5, match_s[2])
...
rule6_match = np.fmin(rule6, match_s[0])
...
rule7_match = np.fmin(rule7, match_s[2])
...
rule8_match = np.fmin(rule8, match_s[0])
...
rule9_match = np.fmin(rule9, match_s[1])
...
rule10_match = np.fmin(rule10, match_s[2])
...
rule11_match = np.fmin(rule11, match_s[1])
...
rule12_match = np.fmin(rule12, match_s[1])
...
rule13_match = np.fmin(rule13, match_s[2])
...
rule14_match = np.fmin(rule14, match_s[1])
...
rule15_match = np.fmin(rule15, match_s[0])
...
rule16_match = np.fmin(rule16, match_s[2])
...
rule18_match = np.fmin(rule18, match_s[0])
...
rule19_match = np.fmin(rule19, match_s[2])
...
rule20_match = np.fmin(rule20, match_s[0])
